...
pub(crate) mod test {
    ...
    /// `VmFlags` of the mapping covering `addr`, from `/proc/self/smaps`
    ...
    fn strides_are_page_aligned_and_unmapped_on_drop() {
        ...
        for e in 0..3 {
            ...
            // The staged header before the gap is 8-byte aligned for the parser
            assert_eq!(
        ...
        // VM_DONTCOPY from MADV_DONTFORK and VM_NORESERVE from MAP_NORESERVE
